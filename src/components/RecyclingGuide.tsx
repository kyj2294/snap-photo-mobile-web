...
const RecyclingGuide: React.FC<RecyclingGuideProps> = ({
  className
}) => {
  ...
  return <div className="p-4 bg-green-50 dark:bg-green-900/20 border-t border-green-100 dark:border-green-800/30">
